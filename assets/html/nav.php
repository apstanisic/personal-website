<nav class="nav" id="nav">
	...
	<a href="#app" class="logo">
		<svg version="1.1" class="logo-svg" xmlns="http://www.w3.org/2000/svg"
			 width="1951.000000pt" height="1913.000000pt" viewBox="0 0 1951.000000 1913.000000"
			 preserveAspectRatio="xMidYMid meet">
			 <title>Logo</title>
			<g transform="translate(0.000000,1913.000000) scale(0.100000,-0.100000)" stroke="none">
		...
		<h1 class="hidden">Aleksandar Stanisic</h1>
	</a>
	...
	<ul class="nav-links">
		...
		<?php if ($page->lang !== $config->default->short): ?>
			<li class="nav-item"><a class="nav-link" href="."><?= $config->default->long; ?></a></li>
		<?php else: ?>
			<li class="nav-item"><a class="nav-link" href="<?= $config->switch->short . '.html'; ?>"><?= $config->switch->long; ?></a></li>
		<?php endif; ?>
	</ul>
