...
const classes = `shadow-md border-gray-400 appearance-none border rounded w-full
                 py-2 px-3 bg-white text-gray-700 text-lg leading-tight `;
  ...
  return (
    <div className="container mx-auto lg:w-3/4">
      ...
      <form className="flex flex-col p-3">
        ...
        <label className="py-2 md:flex ">
          <div className="text-xl p-1 pr-5 md:w-1/3  md:text-right">Email</div>
          <input
            type="email"
            required
            className={classes}
        ...
        <label className="py-2 md:flex ">
          <div className="text-xl p-1 pr-5 md:w-1/3  md:text-right">Poruka</div>
          <textarea
            required
            className={classes}
            rows={8}
